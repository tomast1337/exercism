...
public class JFrmPrincipal extends javax.swing.JFrame {
    ...
    private ControleBasico cA, cC, cF, cP; 
    ...
    private void initComponents() {
        ...
        jMnIFuncionario = new javax.swing.JMenuItem();
        jMnIProjeto = new javax.swing.JMenuItem();
        jSeparatorC = new javax.swing.JPopupMenu.Separator();
        jMnIAloca = new javax.swing.JMenuItem();
        ...
        jMnICargo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_MASK));
        jMnICargo.setFont(new java.awt.Font("DejaVu Sans", 3, 14)); // NOI18N
        ...
        jMnIFuncionario.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.CTRL_MASK));
        jMnIFuncionario.setFont(new java.awt.Font("DejaVu Sans", 3, 14)); // NOI18N
        jMnIFuncionario.setText("Funcionário");
        jMnIFuncionario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMnIFuncionarioActionPerformed(evt);
            }
        });
        jMnCadastro.add(jMnIFuncionario);

        jMnIProjeto.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.CTRL_MASK));
        jMnIProjeto.setFont(new java.awt.Font("DejaVu Sans", 3, 14)); // NOI18N
        jMnIProjeto.setText("Projeto");
        jMnIProjeto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMnIProjetoActionPerformed(evt);
            }
        });
        jMnCadastro.add(jMnIProjeto);

        jSeparatorC.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jMnCadastro.add(jSeparatorC);

        jMnIAloca.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_MASK));
        jMnIAloca.setFont(new java.awt.Font("DejaVu Sans", 3, 14)); // NOI18N
        jMnIAloca.setText("Aloca");
        jMnIAloca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMnIAlocaActionPerformed(evt);
            }
        });
        jMnCadastro.add(jMnIAloca);
        ...
        setSize(new java.awt.Dimension(486, 367));
        setLocationRelativeTo(null);
    ...
    private void jMnIAlocaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnIAlocaActionPerformed
        // TODO add your handling code here:
        JFrmAloca fA = new JFrmAloca();
        fA.setVisible(true);

    }//GEN-LAST:event_jMnIAlocaActionPerformed

    private void jMnIFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnIFuncionarioActionPerformed
        // TODO add your handling code here:
        JFrmFuncionario fF = new JFrmFuncionario();
        fF.setVisible(true);
    }//GEN-LAST:event_jMnIFuncionarioActionPerformed

    private void jMnIProjetoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnIProjetoActionPerformed
        // TODO add your handling code here:
        JFrmProjeto fP = new JFrmProjeto();
        fP.setVisible(true);
    }//GEN-LAST:event_jMnIProjetoActionPerformed

    private void jMnICargoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnICargoActionPerformed
        // TODO add your handling code here:
        JFrmCargo fC = new JFrmCargo();
        fC.setVisible(true);
    ...
    private javax.swing.JMenuItem jMnIAloca;
    private javax.swing.JMenuItem jMnICargo;
    private javax.swing.JMenuItem jMnIFuncionario;
    private javax.swing.JMenuItem jMnIProjeto;
