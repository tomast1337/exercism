...
public class JFrmCargo extends javax.swing.JFrame {
    ...
    public JFrmCargo() {
        ...
        this.titulo =  "Manipulação dos dados do cargo";
        initComponents();
        setSize(450, 250);
        setResizable(false);
 ...
 /*   public void preencheCargo(int Numero){
    ...
    private void limpar() {
         JTextField txt[] = {jTxtNumero, jTxtDescricao};
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLblNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(53, 34, -1, 21));
        ...
        getContentPane().add(jTxtNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(163, 28, 89, 27));
...
// TODO add your handling code here:
   if (Diversos.confirmar("Deseja remover o cargo ?", titulo)) {
       Object o = cC.getBusca(Integer.parseInt( jTxtNumero.getText()), 0);
       Cargo c = (Cargo) o;  
...
// TODO add your handling code here:
      if (jTxtNumero.getText().isEmpty() || jTxtDescricao.getText().isEmpty() )
                    ...
                    if (cC.setManipular(c, 'I')) { //== true
                       ...
                       jBtnExcluir.setEnabled(true);
                         ...
                         Diversos.mostrarDados("Problemas ao inserir os dados " +
                              "do cargo " + jTxtDescricao.getText(), titulo, false);                       
                 jBtnIncluir.setEnabled(false); 
                 
             }     
             else if (cC.setManipular(c,'A')) 
                        Diversos.mostrarDados("O cargo " + jTxtDescricao.getText() +
