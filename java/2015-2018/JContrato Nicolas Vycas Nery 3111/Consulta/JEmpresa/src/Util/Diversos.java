...
public class Diversos {
  private static List <?> desList=new ArrayList<>();

    public static List<?> getDesList() {
        return desList;
    }

    public static void setDesList(List<?> desList) {
        Diversos.desList = desList;
    }
  ...
  public static DefaultFormatterFactory FormatoData(String titulo, int op) {
        ...
        try
        {
          switch(op) {
            ...
            mostrarDados("Data Formatada" + e.getMessage(), titulo, true);
        }
