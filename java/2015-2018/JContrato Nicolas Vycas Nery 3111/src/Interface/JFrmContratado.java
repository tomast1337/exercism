...
public class JFrmContratado extends javax.swing.JFrame {

    ControleBasico cF;
    final String titulo;
  
    public JFrmContratado() {
        this.cF = new ControleContratado();
        this.titulo =  "Manipulação do(a) contratado(a)";
        initComponents();
        setSize(450, 250);
        setResizable(false);
        ...
        try {
           UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
            ...
            Logger.getLogger(JFrmContratado.class.getName()).log(Level.SEVERE, null, ex);
          }   
    }
     
    private void carregaObjetos(Contratado f){
 ...
 /*   public void preencheCargo(int Numero){
    ...
    private void initComponents() {
        ...
        jLblMatricula.setFont(new java.awt.Font("DejaVu Sans", 3, 12)); // NOI18N
        jLblMatricula.setText("Matrícula");
        getContentPane().add(jLblMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, -1, 30));

        jTxtMatricula.setFont(new java.awt.Font("DejaVu Sans", 3, 12)); // NOI18N
        ...
        getContentPane().add(jTxtMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, 100, 27));
         ...
         jTxtMatricula.setText("");
               ...
               jTxtMatricula.setText("");
                   ...
                   if (o == null) {
                      ...
                      Diversos.mostrarDados("Contratado Inexistente",titulo,false);
                  }    
                  else{ 
                        f = (Contratado) o;                       
                        carregaObjetos(f);
...
// TODO add your handling code here:
   if (Diversos.confirmar("Deseja remover o aluno(a)", titulo)) {
       Object o = cF.getBusca(Integer.parseInt( jTxtMatricula.getText()), 0);
       Contratado f = (Contratado) o;  
       if (cF.setManipular(f, 'E')) {
            Diversos.mostrarDados("O(A) aluno(a) " + jTxtNome.getText() + 
         ...
         Diversos.mostrarDados("Problema ao remover o(a) aluno(a) " + 
        ...
        Diversos.mostrarDados("Preencha todos os dados", titulo, false);
             ...
             if (jBtnIncluir.isEnabled()) {
                    if (cF.setManipular(f, 'I')) { //== true
                       Diversos.mostrarDados("O(A) aluno(a) " +
                       ...
                       jBtnExcluir.setEnabled(true);
                         ...
                         Diversos.mostrarDados("Problemas ao inserir os dados " +
                              "do(a) aluno(a) " + jTxtNome.getText(), titulo, false);                       
                 jBtnIncluir.setEnabled(false); 
...
private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmContratado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new JFrmContratado().setVisible(true);
            }
        });
    }
